...
export class AddTablesForBaseFeatures1721162473632 implements MigrationInterface {
    name = 'AddTablesForBaseFeatures1721162473632'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "clan_rank" ("id" SERIAL NOT NULL, "clanId" integer NOT NULL, "rank" character varying NOT NULL, "title" character varying NOT NULL, CONSTRAINT "UQ_49035ca666d89a0df04aa4aeddb" UNIQUE ("rank", "clanId"), CONSTRAINT "PK_e4b1817b754a869e5333fb62ba8" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "member_activity_report" ("id" SERIAL NOT NULL, "uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "receivedAt" TIMESTAMP NOT NULL DEFAULT now(), "data" jsonb NOT NULL, "clanId" integer, "userId" integer, CONSTRAINT "UQ_d578303e8fded30bc733e040181" UNIQUE ("uuid"), CONSTRAINT "PK_07f3197688b196a9c0431bd92f2" PRIMARY KEY ("id"))`);
