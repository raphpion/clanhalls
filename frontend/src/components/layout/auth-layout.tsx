...
function AuthLayout({ children }: Props) {
  return (
    <div className="flex min-h-screen flex-row bg-gradient-to-t from-slate-900 to-slate-800">
      ...
      <div className="flex w-full flex-col items-center bg-white p-5 text-center lg:justify-center lg:rounded-l-xl">
